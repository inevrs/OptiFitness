    ...
    <div className="page">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">Track your meals and calories</p>
        </div>
        ...
        <GlassCard className="p-5 flex justify-between items-center"
          ...
          <div>
            <p className="text-[10px] text-gray-500 uppercase tracking-widest font-semibold">Today's Calories</p>
        ...
        <GlassCard className="p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[10px] text-gray-500 mb-1.5 font-semibold uppercase tracking-widest">Meal / Food Name</label>
            ...
            <div>
              <label className="block text-[10px] text-gray-500 mb-1.5 font-semibold uppercase tracking-widest">Calories (kcal)</label>
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            <p className="text-[10px] text-gray-500 uppercase tracking-widest pl-1">Recent Meals</p>
            {meals.map(meal => (
